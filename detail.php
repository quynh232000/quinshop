            ...
            <div class="wrapper">
                ...
                <div class="detail-body">
                    ...
                    <div class="detail-content">
                        <div class="detail-left">
                            <div class="detail-img">
                                <div class="detail-img-show">
                                    <img src="https://cdn.shopify.com/s/files/1/0824/3121/t/204/assets/iphone14-1682521510040_1200x.png?v=1682521526" alt="">
                                </div>
                                <div class="detail-list-img">
                                    ...
                                    <div class="detail-img-item">
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZxc1zbSkiDcsFHhkosjFiGsd4tPyocjxmIa85BOB03bdcZYclQI_LhIExERJfaNWFsdw&usqp=CAU" alt="">
                                    </div>
                                    <div class="detail-img-item">
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZxc1zbSkiDcsFHhkosjFiGsd4tPyocjxmIa85BOB03bdcZYclQI_LhIExERJfaNWFsdw&usqp=CAU" alt="">
                                    </div>
                        ...
                        <div class="detail-right">
                            <div class="detail-name">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet </div>
                            ...
                            <div class="detail-price">
                                <del class="detail-price-old">$700</del>
                                <div class="detail-price-current">$500</div>
                                <div class="detail-sale">-25%</div>
                            </div>
                            <div class="detail-group">
                                <div class="detail-info-title">Shop discount code</div>
                                <div class="detail-info-content">
                                    <div class="detail-info-sale">Sale $29%</div>
                                </div>
                            </div>
                            <div class="detail-group">
                            ...
                            <div class="detail-group">
                                ...
                                <div class="detail-info-quantity">
                                    <div class="detail-amount">
                                        ...
                                        <input class="detail-info-quantity-item"  value="1" />
                                        <div class="detail-info-quantity-item"><i class="fa-solid fa-plus"></i></div>
                                    </div>
                                    <div class="detail-amount-total">1200 items</div>
                                </div>
                            </div>
                            <div class="detail-btn-body">
                                ...
                                <a href="./cart.php" class="detail-btn detail-btn-buy">BUY NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-desciption">
                    ...
                    <div class="detail-description-body">
                        <div class="detail-description-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet </div>
                        <h4>Special</h4>
                        <div class="detail-description-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet </div>
                        <div class="detail-description-img">
                            <img src="https://cdn.shopify.com/s/files/1/0824/3121/t/204/assets/iphone14-1682521510040_1200x.png?v=1682521526" alt="">
                        </div>
                        <h4>User manual</h4>
                        <div class="detail-description-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet , Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet </div>
                        ...
                        <div class="new-product-wrapper">
                            ...
                            <div class="new-product-body">
                                ...
                                <div class="product ">
                                    ...
                                    <a href="./detail.php" class="product-info">
